...
<div class="max-w-md mx-auto">
    ...
    <div class="bg-white rounded-3xl p-2 shadow-[0_4px_20px_rgba(0,0,0,0.02)] border border-gray-100 flex flex-col">
        ...
        <a href="{{ route('pusat-bantuan') }}" class="flex items-center justify-between p-4 hover:bg-gray-50 rounded-2xl transition group cursor-pointer">
        ...
        <a href="{{ route('dukungan') }}" class="flex items-center justify-between p-4 hover:bg-gray-50 rounded-2xl transition group cursor-pointer">
            <div class="flex items-center gap-4 text-[#545523]">
        ...
        {{-- Menu 3: Bahasa --}}
        <a href="{{ route('bahasa') }}" class="flex items-center justify-between p-4 hover:bg-gray-50 rounded-2xl transition group cursor-pointer">
            <div class="flex items-center gap-4 text-[#545523]">
        ...
        {{-- Menu 4: Laporkan --}}
        <a href="{{ route('laporkan') }}" class="flex items-center justify-between p-4 hover:bg-gray-50 rounded-2xl transition group cursor-pointer">
            <div class="flex items-center gap-4 text-[#545523]">
