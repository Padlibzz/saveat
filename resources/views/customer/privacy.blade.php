...
@section('title', 'Privasi & Keamanan - SaveEat')
@section('page_title', 'Privasi & Keamanan') {{-- Mengisi judul di navbar atas sesuai mockup --}}

@section('content')
<div class="max-w-md mx-auto space-y-6" x-data="{ lokasi: true, notif: false }">
    
    {{-- KARTU UTAMA PENGATURAN --}}
