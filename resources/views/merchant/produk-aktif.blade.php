...
<div x-data="listingAktifComponent()">
    ...
    <div class="flex justify-between items-center border-b border-[#545523]/10 pb-3 mb-6">
        ...
        <a href="{{ route('merchant.upload') }}" class="inline-flex items-center gap-1.5 bg-[#545523] text-[#F1F2CF] text-xs font-bold px-4 py-2.5 rounded-xl shadow-xs hover:bg-[#43441c] transition-all">
    ...
    @if($listings->isEmpty())
        <div class="bg-[#FDFDF5]/50 border-2 border-dashed border-[#545523]/20 rounded-2xl p-12 text-center max-w-xl mx-auto my-8">
            ...
            <a href="{{ route('merchant.upload') }}" class="mt-4 inline-block text-xs bg-[#545523] text-[#F1F2CF] px-5 py-2.5 rounded-xl font-bold shadow-xs hover:bg-[#43441c] transition-all">
