<nav class="flex items-center justify-between w-full mb-6 md:mb-8">
    ...
    <div class="flex items-center gap-3 md:gap-4">
        <a href="{{ route('admin.profile') }}" class="flex items-center gap-2.5 bg-white border border-gray-200 rounded-full pl-2 pr-4 py-1.5 shadow-sm hover:shadow-md transition-all">
